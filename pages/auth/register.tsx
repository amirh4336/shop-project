        ...
        <div className="max-w-[55rem] bg-white rounded-2xl grid grid-cols-2 p-4 mx-auto ">
          <div className="left-side bg-[#f3f5f9] rounded-2xl p-8 pb-0">
            <svg
              ...
              fill="#3c38ff"
              className="bi bi-balloon-fill w-8 h-8"
              viewBox="0 0 16 16"
            >
              <path
                fillRule="evenodd"
            ...
            <h1 className="mt-[4rem] font-bold text-3xl">
              Let us help you run your freelance business.
            </h1>
            <p className="text-slate-500 mt-[2rem] text-lg">
            ...
            >
              <SwiperSlide>
                <div className="bg-[#2d3345] rounded-xl text-white p-9 pb-4 relative overflow-hidden mb-9">
                  ...
                  w-14 absolute -top-4 left-6"
                    viewBox="0 0 16 16"
                  >
                    <path d="M3.05 3.05a7 7 0 0 0 0 9.9.5.5 0 0 1-.707.707 8 8 0 0 1 0-11.314.5.5 0 0 1 .707.707zm2.122 2.122a4 4 0 0 0 0 5.656.5.5 0 1 1-.708.708 5 5 0 0 1 0-7.072.5.5 0 0 1 .708.708zm5.656-.708a.5.5 0 0 1 .708 0 5 5 0 0 1 0 7.072.5.5 0 1 1-.708-.708 4 4 0 0 0 0-5.656.5.5 0 0 1 0-.708zm2.122-2.12a.5.5 0 0 1 .707 0 8 8 0 0 1 0 11.313.5.5 0 0 1-.707-.707 7 7 0 0 0 0-9.9.5.5 0 0 1 0-.707zM6 8a2 2 0 1 1 2.5 1.937V15.5a.5.5 0 0 1-1 0V9.937A2 2 0 0 1 6 8z" />
                  </svg>
                  <p>
                    i'm impressed with the results i've seen since starting to
                    use this product, I begin receiving client and projects in
                    the first week.
                  </p>
